...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923026777409-1632403322@g.us',
    ...
    RG: process.env.RG || '923026777409-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'CHIKU;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://wa.me/message/X7WB6IQAAP63C1',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "CHIKU",
    BOT_NAME: process.env.BOT_NAME || 'CHIKU',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢AZK¹¹ꫂ;CHIKU bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
